...
const PortfolioRecommendation = ({
  ...
  const chartData = [{
    name: "Bitcoin",
    value: portfolio.bitcoin,
    color: "#4335A7"
  }, {
    name: "Ethereum",
    value: portfolio.ethereum,
    color: "#80C4E9"
  }, {
    name: "Altcoins",
    value: portfolio.altcoins,
    color: "#FFF6E9"
  }, {
    name: "Stablecoins",
    value: portfolio.stablecoins,
    color: "#9B8ADB"
  }, {
    name: "Memecoins",
    value: portfolio.memecoins,
    color: "#FF9E9E"
  }].filter(item => item.value > 0);
  const getInvestmentsByType = (type: InvestmentOption["type"]) => {
    return investmentOptions.filter(option => option.type === type).slice(0, 3);
  };
  ...
  return <div className={cn("max-w-4xl mx-auto transition-opacity duration-1000", isVisible ? "opacity-100" : "opacity-0")}>
      <Disclaimer />
      ...
      <div className="mb-12 text-yellow-300 text-center text-2xl">
        <h3 className="font-medium mb-6 text-lg">Contáctame para una asesoría personalizada y te ayudo con todas las dudas que tengas.</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {portfolio.diversificationTips.map((tip, index) => <div key={index} className="p-4 border border-border rounded-xl bg-card">
      ...
      <div className="mb-16">
        ...
        <div className="mb-8">
          ...
          <div className="p-4 border border-border rounded-xl bg-card mb-4">
            ...
            <p className="text-foreground/80 mt-1">
              <a href="https://www.coingecko.com/es/monedas/bitcoin" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                Ver en CoinGecko
              </a>
            </p>
          </div>
        ...
        <div className="mb-8">
          ...
          <div className="p-4 border border-border rounded-xl bg-card mb-4">
            ...
            <p className="text-foreground/80 mt-1">
              <a href="https://www.coingecko.com/es/monedas/ethereum" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                Ver en CoinGecko
              </a>
            </p>
          </div>
        ...
        {portfolio.altcoins > 0 && <div className="mb-8">
          ...
          <div className="space-y-3">
            <div className="p-4 border border-border rounded-xl bg-card">
              <p className="text-foreground/80">
                ...
                <a href="https://www.coingecko.com/es/monedas/tether" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Ver en CoinGecko
                </a>
              </p>
            </div>
            <div className="p-4 border border-border rounded-xl bg-card">
              <p className="text-foreground/80">
                ...
                <a href="https://www.coingecko.com/es/monedas/usdc" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Ver en CoinGecko
                </a>
              </p>
            </div>
            <div className="p-4 border border-border rounded-xl bg-card">
              <p className="text-foreground/80">
                ...
                <a href="https://www.coingecko.com/es/monedas/usds" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                  Ver en CoinGecko
                </a>
              </p>
            </div>
        ...
        {portfolio.memecoins > 0 && <div className="mb-8">
      ...
      <div className="text-center mb-8">
        <button onClick={onStartOver} className="px-6 py-3 bg-primary text-primary-foreground rounded-full hover:bg-primary/90 transition-colors shadow-sm">
          Comenzar de Nuevo
        </button>
      </div>
    </div>;
